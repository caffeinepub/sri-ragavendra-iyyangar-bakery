...
export class Backend implements backendInterface {
    ...
    async createBakery(arg0: string, arg1: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.createBakery(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getBakery(arg0: string): Promise<Bakery> {
        if (this.processError) {
            try {
                const result = await this.actor.getBakery(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async listBakeries(): Promise<Array<Bakery>> {
        if (this.processError) {
            try {
                const result = await this.actor.listBakeries();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
